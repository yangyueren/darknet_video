...
void draw_detections_cv_v3_yyy(mat_cv* show_img, detection *dets, int num, float thresh, char **names, image **alphabet, int classes, int ext_output, long long frame_id, char* folder_name);
